...
POST /item/{item_id}/category — moves an active-list item to a different section ({category: str}, must be one of the six categories); powers the category chips in the inline ✎ edit
